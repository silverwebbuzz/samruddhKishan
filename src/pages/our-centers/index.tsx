...
const OurCentersPage = () => {
  ...
  const { centersData, centersCountData } = useSelector(
    (state: any) => state?.rootReducer?.centersReducer
  );
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="center_address">
                            <h5>ADDRESS:</h5>
                            <p>
                              {`${Itm.taluka ? Itm.taluka : ""}, ${
                                Itm?.city ? Itm?.city : ""
                              }`}
                              <br />
                              {`${Itm?.state ? Itm?.state : ""}, ${
                                Itm?.pinCode ? Itm?.pinCode : ""
                              }, IN`}
                            </p>
                          </div>
                        </div>
...
OurCentersPage.getLayout = (page: ReactNode) => (
