...
const ChangePasswordCard = () => {
  ...
  const handleClickShowCurrentPassword = () => {
    setValues1({
      ...values1,
      showCurrentPassword: !values1.showCurrentPassword,
    });
  };
  ...
  const handleClickShowConfirmNewPassword = () => {
    setValues1({
      ...values1,
      showConfirmNewPassword: !values1.showConfirmNewPassword,
    });
  };
  ...
  const handleSubmit = async (values: any) => {
    ...
    const res = await axios.post(
      `${process.env.NEXT_PUBLIC_BASE_URL}/admin/changePassword`,
      payload,
      {
        headers: {
                ...
                <Grid item xs={12} sm={6}>
                  <FormControl fullWidth>
                    ...
                    <OutlinedInput
                      ...
                      type={
                        values1.showConfirmNewPassword ? "text" : "password"
                      }
                      endAdornment={
                        <InputAdornment position="end">
                          <IconButton
                          ...
                          >
                            <Icon
                              icon={
                                values1.showConfirmNewPassword
                                  ? "tabler:eye"
                                  : "tabler:eye-off"
                              }
                            />
