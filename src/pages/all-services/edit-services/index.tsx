...
const editServices = () => {
  ...
  const { singleService } = useSelector(
  ...
  const [availabilityStartDayPrefill, setAvailabilityStartDayPrefill] =
    useState("");
  const [availabilityEndDayPrefill, setAvailabilityEndDayPrefill] =
    useState("");
  ...
  const handleServices = (values: any, { resetForm }: any) => {
    ...
    formdata.append(
      "minOrderQuantity",
      values?.minOrderQuantity ? values?.minOrderQuantity : 0
    );
  ...
  useEffect(() => {
    ...
    singleService?.categoryId,
    singleService?.serviceType,
    singleService?.setVendorId,
  ]);
              ...
              <Grid container spacing={5}>
                ...
                <Grid item xs={6} sm={6}>
                  <TextField
                    ...
                    error={
                      errors?.serviceName && touched?.serviceName ? true : false
                    }
                    onBlur={handleBlur}
                ...
                <Grid item xs={6} sm={6}>
                  <TextField
                    ...
                    type="text"
                    helperText={
                      errors?.serviceLocation && touched?.serviceLocation
                ...
                <Grid item xs={6} sm={6}>
                  <TextField
                    ...
                    type="text"
                    helperText={
                      errors?.minOrderQuantity && touched?.minOrderQuantity
                ...
                >
                  <Grid item xs={6}>
                    <Typography variant="h6">
                      Upload your Service Banner Image:
                    </Typography>
                    <Box
                      sx={{
                        display: "flex",
