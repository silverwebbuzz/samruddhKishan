...
export const GetAllProductMainPage = createAsyncThunk(
  "user/GetAllProductMainPage",
  async (
    payload: { page: string | number; pageSize: string | number },
    { rejectWithValue }
  ) => {
    try {
      const res = await axios.post(
        `${process.env.NEXT_PUBLIC_BASE_URL}/product/GetAllProductMainPage`,
        payload,
        {
          headers,
        }
  ...
  async (
    ...
    try {
      const res = await axios.get(
        `${process.env.NEXT_PUBLIC_BASE_URL}/farmer/getAllUnits`,
        payload,
        {
          headers,
        }
...
export const getAllCountry = createAsyncThunk(
  ...
  async (
    ...
    try {
      const res = await axios.get(
        `${process.env.NEXT_PUBLIC_BASE_URL}/farmer/getAllCountry`,
        payload,
        {
          headers,
        }
...
export const getProductById = createAsyncThunk(
  ...
  async (payload, { rejectWithValue }) => {
    try {
      const res = await axios.get(
        `${process.env.NEXT_PUBLIC_BASE_URL}/product/getsingleProduct/${payload?.id}`,
        {
          headers,
        }
      );
...
export const updateProduct = createAsyncThunk(
  ...
  async (payload: any, { rejectWithValue }) => {
    try {
      const res = await axios.post(
        `${process.env.NEXT_PUBLIC_BASE_URL}/product/updateProduct`,
        payload,
        {
          "Access-Control-Allow-Origin": "*",
          "Content-Type": "multipart/form-data",
  ...
  async (payload: any, { rejectWithValue }) => {
    try {
      const res = await axios.delete(
        `${process.env.NEXT_PUBLIC_BASE_URL}/product/deleteProduct/${payload?.id}`,
        {
          headers,
        }
      );
...
export const deleteMultipleProduct = createAsyncThunk(
  ...
  async (payload: any, { rejectWithValue }) => {
    try {
      const res = await axios.post(
        `${process.env.NEXT_PUBLIC_BASE_URL}/product/multiDeleteProduct`,
        payload,
        {
          headers,
        }
...
export const productSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder.addCase(GetAllProductMainPage.pending, (state) => {
      state.isLoading = true;
    });
    builder.addCase(GetAllProductMainPage.fulfilled, (state, action) => {
      state.isLoading = false;
      state.allProductsData = action.payload;
    });
    builder.addCase(GetAllProductMainPage.rejected, (state) => {
      state.isLoading = false;
    });
