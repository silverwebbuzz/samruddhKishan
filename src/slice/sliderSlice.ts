...
export const getAllSlides = createAsyncThunk('user/getAllSlides', async (payload, { rejectWithValue }) => {
  try {
    const res = await axios.get(`${process.env.NEXT_PUBLIC_BASE_URL}/contentPage/getAllSliderImages`, payload, {
      headers
    })
...
export const createSlide = createAsyncThunk('user/createSlide', async (payload, { rejectWithValue }) => {
  try {
    const res = await axios.post(`${process.env.NEXT_PUBLIC_BASE_URL}/contentPage/sliderImage`, payload, {
      'Access-Control-Allow-Origin': '*',
...
export const updateSlide = createAsyncThunk('user/updateSlide', async (payload: any, { rejectWithValue }) => {
  try {
...
export const deleteSlide = createAsyncThunk('user/deleteSlide', async (payload: any, { rejectWithValue }) => {
  try {
