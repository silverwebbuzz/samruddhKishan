    ...
    try {
      if (payload) {
        const res = await axios.post(
          `${process.env.NEXT_PUBLIC_BASE_URL}/categories/GetAllCategory`,
          payload,
          {
            headers,
          }
...
export const createCategory = createAsyncThunk(
  ...
  async (payload, { rejectWithValue }) => {
    try {
      const res = await axios.post(
        `${process.env.NEXT_PUBLIC_BASE_URL}/categories/createCategories`,
        payload,
        {
          headers,
        }
...
export const updateMultipleCategoryStatus = createAsyncThunk(
  ...
  async (payload: any, { rejectWithValue }) => {
    try {
      const res = await axios.post(
        `${process.env.NEXT_PUBLIC_BASE_URL}/categories/updateMultiSelectStatus`,
        payload,
        {
          headers,
        }
  ...
  async (payload: any, { rejectWithValue }) => {
    try {
      const res = await axios.delete(
        `${process.env.NEXT_PUBLIC_BASE_URL}/categories/deleteCategories/${payload?.id}`,
        {
          headers,
        }
      );
...
export const deleteMultipleCategory = createAsyncThunk(
  ...
  async (payload: any, { rejectWithValue }) => {
    try {
      const res = await axios.post(
        `${process.env.NEXT_PUBLIC_BASE_URL}/categories/multiDeleteCategories`,
        payload,
        {
          headers,
        }
