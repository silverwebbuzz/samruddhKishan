...
export const getGeneralAPI = createAsyncThunk('user/getGeneralAPI', async (_, { rejectWithValue }) => {
  try {
    const res = await axios.post(`${process.env.NEXT_PUBLIC_BASE_URL}/settings/getSingleSetting`, {
      headers
    })
...
export const getEmailAPI = createAsyncThunk('user/getEmailAPI', async (payload, { rejectWithValue }) => {
  try {
    const res = await axios.post(`${process.env.NEXT_PUBLIC_BASE_URL}/settings/createEmailSetting`, payload, {
      headers
    })
    toast.success('Updated successfully')
    return res?.data?.data
...
export const createSocialSettingAPI = createAsyncThunk(
  ...
  async (payload, { rejectWithValue }) => {
    try {
      const res = await axios.post(`${process.env.NEXT_PUBLIC_BASE_URL}/settings/createSocialMedia`, payload, {
        headers
      })
      toast.success('Updated successfully')
      return res?.data?.data
...
export const createGoogleAPI = createAsyncThunk('user/createGoogleAPI', async (payload, { rejectWithValue }) => {
  try {
    const res = await axios.post(`${process.env.NEXT_PUBLIC_BASE_URL}/settings/updateGoogleSetting`, payload, {
      headers
    })
    toast.success('Updated successfully')
    return res?.data?.data
...
export const createSeoAPI = createAsyncThunk('user/createSeoAPI', async (payload, { rejectWithValue }) => {
  try {
    const res = await axios.post(`${process.env.NEXT_PUBLIC_BASE_URL}/settings/updateScoSetting`, payload, {
      headers
    })
    toast.success('Updated successfully')
    return res?.data?.data
