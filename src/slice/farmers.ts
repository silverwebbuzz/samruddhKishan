  ...
  async (payload: any, { rejectWithValue }) => {
    try {
      const res = await axios.post(
        `${process.env.NEXT_PUBLIC_BASE_URL}/farmer/getAllFarmer`,
        payload,
        {
          headers,
        }
...
export const getAllDistrict = createAsyncThunk(
  "farmers/getAllDistrict",
  async (payload: any, { rejectWithValue }) => {
    try {
      const res = await axios.post(
        `${process.env.NEXT_PUBLIC_BASE_URL}/farmer/getAllCity`,
        payload,
        {
          headers,
        }
...
export const createUser1 = createAsyncThunk(
  "farmers/createUser",
  async (payload: any, { rejectWithValue }) => {
    try {
      const res = await axios.post(
        `${process.env.NEXT_PUBLIC_BASE_URL}/user/createUsers`,
        payload,
        {
          "Access-Control-Allow-Origin": "*",
...
export const updateUser1 = createAsyncThunk(
  "farmers/updateUser1",
  async (payload: any, { rejectWithValue }) => {
    try {
      const res = await axios.post(
        `${process.env.NEXT_PUBLIC_BASE_URL}/user/updateUsers`,
        payload,
        {
          "Access-Control-Allow-Origin": "*",
          "Content-Type": "multipart/form-data",
...
export const getSingleFarmer = createAsyncThunk(
  "farmer/getSingleFarmer",
  async (payload: any, { rejectWithValue }) => {
    try {
      const res = await axios.get(
        `${process.env.NEXT_PUBLIC_BASE_URL}/farmer/getSingleFarmer/${payload?.id}`,
        {
          headers,
        }
      );
  ...
  async (payload: any, { rejectWithValue }) => {
    try {
      const res = await axios.delete(
        `${process.env.NEXT_PUBLIC_BASE_URL}/farmer/deleteFarmer/${payload?.id}`,
        {
          headers,
        }
      );
...
export const deleteMultipleFarmer = createAsyncThunk(
  ...
  async (payload: any, { rejectWithValue }) => {
    try {
      const res = await axios.post(
        `${process.env.NEXT_PUBLIC_BASE_URL}/farmer/multiDeleteFarmer`,
        payload,
        {
          headers,
        }
...
export const deleteMultipleUsers = createAsyncThunk(
  ...
  async (payload: any, { rejectWithValue }) => {
    try {
      const res = await axios.post(
        `${process.env.NEXT_PUBLIC_BASE_URL}/user/multiDeleteUsers`,
        payload,
        {
          headers,
        }
...
export const getAdressByPincode = createAsyncThunk(
  ...
  async (payload: any, { rejectWithValue }) => {
    try {
      const res = await axios.get(
        `${process.env.NEXT_PUBLIC_BASE_URL}/farmer/GetPinCode/${payload?.pincode}`,
        {
          headers,
        }
      );
...
export const getAllState = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      const res = await axios.post(
        `${process.env.NEXT_PUBLIC_BASE_URL}/farmer/getAllState`,
        {
          headers,
        }
      );
...
export const uploadImage = createAsyncThunk(
  ...
  async (payload: any, { rejectWithValue }) => {
    try {
      const res = await axios.post(
        `${process.env.NEXT_PUBLIC_BASE_URL}/farmer/uploadImage`,
        payload,
        {
          headers,
        }
...
export const createRoleAndPermission = createAsyncThunk(
  ...
  async (payload: any, { rejectWithValue }) => {
    try {
      const res = await axios.post(
        `${process.env.NEXT_PUBLIC_BASE_URL}/role/createURole`,
        payload,
        {
          headers,
        }
...
export const getRoleAndPermissions = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      const res = await axios.post(
        `${process.env.NEXT_PUBLIC_BASE_URL}/role/GetAllRole`,
        {
          headers,
        }
      );
...
export const getAllUsers = createAsyncThunk(
  "farmers/getAllUsers",
  async (
    payload: { page?: string | number; pageSize?: string | number },
    { rejectWithValue }
  ) => {
    try {
      const res = await axios.post(
...
export const createPermissions = createAsyncThunk(
  ...
  async (payload: any, { rejectWithValue }) => {
    try {
      const res = await axios.post(
        `${process.env.NEXT_PUBLIC_BASE_URL}/permission/createPermission`,
        payload,
        {
          headers,
        }
...
export const getAllPermission = createAsyncThunk(
  ...
  async (
    ...
    try {
      if (payload) {
        const res = await axios.post(
          `${process.env.NEXT_PUBLIC_BASE_URL}/permission/GetAllPermission`,
          payload,
          {
            headers,
          }
...
export const updatePermissions = createAsyncThunk(
  ...
  async (payload: any, { rejectWithValue }) => {
    try {
      const res = await axios.post(
        `${process.env.NEXT_PUBLIC_BASE_URL}/permission/updatePermission`,
        payload,
        {
          headers,
        }
...
export const updateRoles = createAsyncThunk(
  ...
  async (payload: any, { rejectWithValue }) => {
    try {
      const res = await axios.post(
        `${process.env.NEXT_PUBLIC_BASE_URL}/role/updateRole`,
        payload,
        {
          headers,
        }
...
export const deleteUser = createAsyncThunk(
  ...
  async (payload: any, { rejectWithValue }) => {
    try {
      const res = await axios.delete(
        `${process.env.NEXT_PUBLIC_BASE_URL}/user/deleteUsers/${payload?.id}`,
        {
          headers,
        }
      );
...
export const deleteRole = createAsyncThunk(
  ...
  async (payload: any, { rejectWithValue }) => {
    try {
      const res = await axios.delete(
        `${process.env.NEXT_PUBLIC_BASE_URL}/role/deleteRole/${payload?.id}`,
        {
          headers,
        }
      );
...
export const deletePermissions = createAsyncThunk(
  ...
  async (payload: any, { rejectWithValue }) => {
    try {
      const res = await axios.delete(
        `${process.env.NEXT_PUBLIC_BASE_URL}/permission/deletePermission/${payload?.id}`,
        {
          headers,
        }
      );
...
export const createContentPage = createAsyncThunk(
  ...
  async (payload: any, { rejectWithValue }) => {
    try {
      const res = await axios.post(
        `${process.env.NEXT_PUBLIC_BASE_URL}/contentPage/createContentPage`,
        payload,
        {
          headers,
        }
