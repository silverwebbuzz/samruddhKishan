    ...
    try {
      if (payload) {
        const res = await axios.post(
          `${process.env.NEXT_PUBLIC_BASE_URL}/service/GetAllServices`,
          payload,
          {
            headers,
          }
...
export const createService = createAsyncThunk(
  ...
  async (payload, { rejectWithValue }) => {
    try {
      const res = await axios.post(
        `${process.env.NEXT_PUBLIC_BASE_URL}/service/createServices`,
        payload,
        {
          //   headers
          "Access-Control-Allow-Origin": "*",
...
export const updateService = createAsyncThunk(
  ...
  async (payload: any, { rejectWithValue }) => {
    try {
      const res = await axios.post(
        `${process.env.NEXT_PUBLIC_BASE_URL}/service/updateServices`,
        payload,
        {
          "Access-Control-Allow-Origin": "*",
          "Content-Type": "multipart/form-data",
  ...
  async (payload: any, { rejectWithValue }) => {
    try {
      const res = await axios.get(
        `${process.env.NEXT_PUBLIC_BASE_URL}/service/singleServices/${payload?.id}`,
        {
          headers,
        }
      );
  ...
  async (payload: any, { rejectWithValue }) => {
    try {
      const res = await axios.delete(
        `${process.env.NEXT_PUBLIC_BASE_URL}/service/deleteService/${payload?.id}`,
        {
          headers,
        }
      );
...
export const deleteMultipleServices = createAsyncThunk(
  ...
  async (payload: any, { rejectWithValue }) => {
    try {
      const res = await axios.post(
        `${process.env.NEXT_PUBLIC_BASE_URL}/service/multiDeleteServices`,
        payload,
        {
          headers,
        }
...
export const updateMultipleServiceStatus = createAsyncThunk(
  ...
  async (payload: any, { rejectWithValue }) => {
    try {
      const res = await axios.post(
        `${process.env.NEXT_PUBLIC_BASE_URL}/service/updateServicesStatus`,
        payload,
        {
          headers,
        }
